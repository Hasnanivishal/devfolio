...
export default function Office(props) {
  const { nodes, materials } = useGLTF(
    "/models/portfolio_scene_baked_final.glb"
  );
  return (
    <group {...props} dispose={null}>
      ...
      <group
        name="iMac"
        // position={[0.100, 0.92, -1.552]}
        position={[0.380, 0.92, -1.652]}
...
useGLTF.preload("/models/portfolio_scene_baked_final.glb");
